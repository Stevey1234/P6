...
HEADER_TYPES_FILE = '/home/apoorv/zsolt-thesis/demo/build/header_types.txt'
OUTPUT_FILE = '/home/apoorv/zsolt-thesis/demo/build/code_reader_output.txt'
HEADERS_PY = '/home/apoorv/zsolt-thesis/demo/build/headers.py'
...
def pre_check():
  ...
  if len(sys.argv)<2:
      print 'Correct usage: p4_code_reader_v2.py <path_to_the_p4_code>'
      exit(1)
  if len(sys.argv)>3:
